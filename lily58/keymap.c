...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTZ] = LAYOUT(
        ...
        KC_LCTL, DE_Y, KC_X, KC_C, KC_V, KC_B, LT(_MEDIA,KC_PGUP), LT(_MEDIA,KC_PGDN), KC_N, KC_M, DE_COMM, DE_DOT, DE_MINS, KC_RCTL,
    ...
    // |---------+----------+------------+------------+------------+----------|                |---------+----------+------------+------------+------------+------------|
        ____,       DE_LPRN,    DE_LPRN,    DE_LABK,    DE_RABK,    DE_EQL,                     KC_NUM,     KC_P7,      KC_P8,      KC_P9,      KC_KP_SLASH,    KC_F12,   
    // |---------+----------+------------+------------+------------+----------|                |---------+----------+------------+------------+------------+------------|
        KC_CAPS,    DE_LCBR,    DE_RCBR,    DE_AMPR,    DE_PIPE,    DE_PLUS,                    ____,       KC_P4,      KC_P5,      KC_P6,      KC_KP_ASTERISK, ____,
    // |---------+----------+------------+------------+------------+----------|                |---------+----------+------------+------------+------------+------------|
        ____,       K_BRTO,     K_BRTC,     DE_ASTR,    DE_TILD,    DE_MINS,    ____,     ____, KC_P0,      KC_P1,      KC_P2,      KC_P3,      KC_KP_PLUS,     ____,
    // |---------+----------+------------+------------+------------+----------|                |---------+----------+------------+------------+------------+------------|
                ____,       ____,       ____,       ____,                                           ____, ____, ____, ____
    ),  

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTZ] = LAYOUT(
        ...
        KC_LCTL, DE_Y, KC_X, KC_C, KC_V, KC_B, MO(_MEDIA),              ____, KC_N, KC_M, DE_COMM, DE_DOT, DE_MINS, ____,
            KC_RCMD, TT(_RACING), BSPLT(_EXTENDED), KC_LALT,                 KC_RALT, SPLT(_RAISE), KC_ENTER, KC_DEL
    ),
    ...
    // ,---------------------------------------------------------------------.                 ,------------------------------------------------------------------------.
        ____,       ____,       ____,       ____,       ____,       ____,                       ____,       ____,       ____,       ____,       ____,       ____,
    // |---------+----------+------------+------------+------------+----------|                |---------+----------+------------+------------+------------+------------|
        ____,       ____,       ____,       ____,       ____,       ____,                       ____,       DE_UDIA,    ____,       DE_ODIA,    ____,       ____,   
    // |---------+----------+------------+------------+------------+----------|                |---------+----------+------------+------------+------------+------------|
        ____,       DE_ADIA,    ____,       ____,       ____,       ____,                       ____,       ____,       ____,       ____,       ____,       ____,
    // |---------+----------+------------+------------+------------+----------|                |---------+----------+------------+------------+------------+------------|
        ____,       ____,       ____,       ____,       ____,       ____,       ____,   ____,   ____,       ____,       ____,       ____,       ____,       ____,
    // |---------+----------+------------+------------+------------+----------|                |---------+----------+------------+------------+------------+------------|
                ____,       ____,       ____,       ____,                                           ____,       ____,       ____,       ____
